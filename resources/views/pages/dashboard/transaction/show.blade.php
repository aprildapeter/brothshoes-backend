                 ...
                 <div class="p-6 bg-white border-b border-gray-200">
                    <table class="table-auto w-full">
                        <tbody>
                            ...
                            <tr>
                                <th class="border px-6 py-4 text-right">Foto User</th>
                                <td class="border px-6 py-4"><img src="{{ $transaction->user->img_url }}" style="height: 100px; width: 100px; border-radius: 20px;"></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <th class="border px-6 py-4 text-right">Patokan</th>
                                <td class="border px-6 py-4">{{ $transaction->patokan }}</td>
                            </tr>
                            <tr>
                                <th class="border px-6 py-4 text-right">Detail Lokasi</th>
                                <td class="border px-6 py-4">{{ $transaction->detail_lokasi }}</td>
                            </tr>
                            <tr>
